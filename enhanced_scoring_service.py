...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('anomaly_detection_engine.log'),
...
# Configuration
MODEL_PATH = os.environ.get('ENSEMBLE_MODEL_PATH', '/Users/hasanb/Desktop/MDX-DOCS/CST-4090/code/thesis_real_time_log_anomaly_repo/ensemble/models/line_level_ensemble_v2/line_level_ensemble_v2_results.joblib')
...
DB_PATH = os.environ.get('ANOMALY_DB_PATH', 'anomaly_detection.db')
...
def get_stats():
    ...
    return {
        ...
        'qdrant_queries': stats['qdrant_queries'],
...
def health_check():
    ...
    all_services_ok = all([model_loaded, redis_available, qdrant_available, db_available])
