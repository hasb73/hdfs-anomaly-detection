...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('./anomaly-detection-service/anomaly_detection_service.log'),
...
DB_PATH = os.environ.get('ANOMALY_DB_PATH', './anomaly-detection-serviceanomaly_detection.db')
